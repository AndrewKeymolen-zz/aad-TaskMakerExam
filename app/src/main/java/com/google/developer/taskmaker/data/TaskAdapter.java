...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskHolder> {
    ...
    //New code from Andrew Keymolen Feature Tasks 4 and 5
    ...
    public void onBindViewHolder(TaskHolder holder, int position) {
        //New code from Andrew Keymolen Feature Tasks 4 and 5
        holder.nameView.setText(getItem(position).description);
        holder.dateView.setText(getItem(position).hasDueDate() ?
                DateUtils.getRelativeTimeSpanString(getItem(position).dueDateMillis) : "");
        holder.priorityView.setImageResource(getItem(position).isPriority ?
        ...
        } else if (getItem(position).hasDueDate() &&
                getItem(position).dueDateMillis < Calendar.getInstance().getTimeInMillis()) {
